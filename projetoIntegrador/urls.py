...
from main.views import NotasCreateView, NotasDeleteView, NotasListView, NotasUpdateView, MediaPonderadaView
...
urlpatterns = [
    ...
    path('media-list', MediaPonderadaView.as_view(), name='media_list'),
